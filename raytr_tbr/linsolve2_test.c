...
int main(){
  ...
  int const N = 3, M = 3; // Specify here the system size
  int i, j;
  //
  ...
  double b2[3] = {-0.56016294,  0.9195913 ,  0.45032625};
  double b3[3] = {-0.56016294,  0.9195913 ,  0.45032625};
  double x2[3], c[3];
  //double b[100], b1[100], x[100], a[100][100], a1[100][100];
  double a1[3][3], ai[3][3];
